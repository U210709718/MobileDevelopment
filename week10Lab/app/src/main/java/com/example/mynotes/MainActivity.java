...
import com.example.mynotes.R; // Correct R import
...
@Override
    ...
    private void saveContent(Note note, String content) {
        ...
        Log.d("Saving tp Pref","key = " + file.getName() +" value = " + editingNote);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        Log.d("OnPrepareOptionMenu new visible", menu.findItem(R.id.action_new).isVisible() + "");
